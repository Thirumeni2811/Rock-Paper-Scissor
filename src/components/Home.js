    ...
    <>  
        <div className='h-screen flex flex-col'>
            ...
            <div className='flex flex-col justify-center items-center flex-grow bg-blackPearl p-3'>
                ...
                <h1 className='text-5xl font-extrabold text-luckyOrange xs:text-4xl'>
                    Rock Paper Scissor
                    <Link to='/rules'>
                ...
                <div className='m-12'>
                    <button className="ring-4 ring-floralWhite px-8 py-1.5 text-luckyOrange font-bold text-2xl rounded-md">Play</button>            
                </div>
            </div>
        </div>
