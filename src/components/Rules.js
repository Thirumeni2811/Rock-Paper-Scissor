...
const Rules = () => {
  return (
    <>
        <section>
            <Navbar />
            <div className='bg-blackPearl text-justify p-8 xs:p-6 xs:py-1 lg:flex lg:justify-center'>
                ...
                <div className='lg:w-4/6 lg:flex lg:flex-col '>
                    ...
                    <div className='px-6 my-4 xs:px-0'>
                        ...
                        <p className='text-floralWhite indent-8 my-4 font-bold xs:indent-6'> 
                            Those who get 10 points first are the winners.                    
                        </p>
                    </div>
